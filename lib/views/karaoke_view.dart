                        ...
                        child: ClipRRect(
                          child: ShaderMask(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: controller.lyricsData.value!.segments.length,
                              itemBuilder: (context, index) {
                                final segment = controller.lyricsData.value!.segments[index];
                                final isActive = index == controller.activeLineIndex.value;
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            // Current time
                            Text(
                              controller.formatDuration(controller.currentTime.value),
